...
data_dir = "kaggle-cat-vs-dog-dataset/versions/1/kagglecatsanddogs_3367a/PetImages"
save_model_path = "cat_dog_classifier.pth"
...
model = CatDogClassifier().to(device)  # Premakni model na ustrezno napravo (GPU ali CPU)
...
def train_and_validate():
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoh [{epoch + 1}/{num_epochs}], Izguba pri treniranju: {train_losses[-1]:.4f}, Izguba pri validaciji: {val_losses[-1]:.4f}")
